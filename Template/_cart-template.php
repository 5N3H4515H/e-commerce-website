        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-3">
                        <img src="<?php echo $item['item_image'] ?? "./assets/products/1.jpg" ?>" style="height: 120px;" alt="cart1" class="img-fluid">
                    </div>
                    <div class="col-sm-7">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        ...
                        <button type="submit" class="btn btn-warning mt-3"><a href="checkout.php">Proceed to Buy</button>
                    </div>
                </div>
            </div>
            <!-- !subtotal section-->
